...
int main(int argc, char **argv) {
    ...
    gint64 distinct_positions = count_distinct_positions_in_path(file_contents);
    gint64 infinitely_blockable_positions_in_path = count_infinitely_blockable_positions_in_path(file_contents);
